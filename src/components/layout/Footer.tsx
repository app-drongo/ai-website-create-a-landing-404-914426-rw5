  ...
  const footerSections = [
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Implementation Blog', href: '/blog' },
        { name: 'SAP Consultants', href: '/consultants' },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'SOX Compliance', href: '/compliance' },
      ],
    },
  ];
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                Streamlining enterprise SAP integrations with cutting-edge automation and real-time
                data synchronization. Trusted by Fortune 500 companies for seamless ERP connectivity
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">+1 (800) SAP-LINK</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
                <MapPin className="size-4 text-primary flex-shrink-0" />
                <span className="text-muted-foreground">Enterprise Plaza, Silicon Valley</span>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground">
                Receive SAP integration insights and platform updates. Enterprise-focused content
                only.
              </p>
            </div>
          </div>
